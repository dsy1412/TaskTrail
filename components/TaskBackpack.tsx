      ...
      <div className="glass-panel overflow-hidden rounded-xl">
        <div className="flex items-center justify-between gap-3 border-b border-slate-800 px-3 py-3 sm:px-4">
          <div className="min-w-0">
            <h2 className="text-base font-semibold text-slate-50 sm:hidden">Task Backpack</h2>
            ...
            <p className="text-xs font-medium text-slate-400 sm:hidden">
              {activeTasks.length} queued tasks
            </p>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex min-w-20 items-center justify-center gap-1.5 rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-xs font-semibold text-slate-300 shadow-sm transition hover:text-slate-50 sm:min-w-0 sm:px-2"
              onClick={() => setOpen((value) => !value)}
            >
              {open ? <ChevronDown className="h-4 w-4" /> : <ChevronUp className="h-4 w-4" />}
              <span className="sm:hidden">{open ? "Hide" : "Open"}</span>
            </button>
          </div>
        </div>
